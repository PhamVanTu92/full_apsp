...
namespace BackEndAPI.Controllers
{
    ...
    {
        private readonly IService<AreaLocation> _iService;
        private readonly IHostingEnvironment _hostingEnvironment;
        private readonly IMapper _mapper;
        public AreaLocationController(IService<AreaLocation> iService, IHostingEnvironment hostingEnvironment, IMapper mapper)
        {
            _iService = iService;
        ...
        [AllowAnonymous]
        [HttpPost("add")]
        public async Task<IActionResult> CreateBrand(AreaLocation model)
        {
            Mess mes = new Mess();
            if (model == null)
            {
        ...
        [AllowAnonymous]
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateBrand(int id, AreaLocation model)
        {
            Mess mes = new Mess();
            if (model == null)
            {
