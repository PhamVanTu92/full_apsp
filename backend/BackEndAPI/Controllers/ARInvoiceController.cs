...
namespace BackEndAPI.Controllers
{
    ...
    public class ARInvoiceController : ControllerBase
    {
        ...
        //public ARInvoiceController(IDocumentService arService, IHostingEnvironment hostingEnvironment, IMapper mapper)
        //{
        ...
        //    }
        //    var (itemGroup, mess) = await _arService.AddDocumentAsync(model, 13);
        //    if (mess != null)
        //    {
        ...
        //{
        //    var (items, total,mess) = await _arService.GetAllDocumentAsync(skip, limit, 13);
        //    if (mess != null)
        //    {
        //        return BadRequest(new { mess.Status, mess.Errors });
        //    }    
        ...
        //{
        //    var (item,mess) = await _arService.GetDocumentByIdAsync(id, 13);
        //    if (mess != null)
        //    {
        //        return BadRequest(new { mess.Status, mess.Errors });
        //    }
        ...
        //{
        //    var (item,mess) = await _arService.GetDocumentAsync(search, 13);
        //    if (mess != null)
        //    {
        //        return BadRequest(new { mess.Status, mess.Errors });
        //    }
