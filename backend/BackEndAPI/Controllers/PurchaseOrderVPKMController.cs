...
namespace BackEndAPI.Controllers
{
    ...
    public class PurchaseOrderVPKMController : Controller
    {
        private readonly IDocumentService _arService;
        private readonly IMapper _mapper;

        public PurchaseOrderVPKMController(IDocumentService arService,IMapper mapper)
        {
            _arService = arService;
            _mapper = mapper;
        }
        [PrivilegeRequirement("OrderVPKM.Create")]
        [HttpPost]
        [Route("add")]
        ...
        [PrivilegeRequirement("OrderVPKM.View")]
        [HttpGet]
            ...
            int limit = 30)
        {
            ...
            string serverCondition = "DocType=VPKM";
        ...
        [PrivilegeRequirement("OrderVPKM.UploadDocuments")]
        [HttpPut("{id}")]
        ...
        [PrivilegeRequirement("OrderVPKM.Complete")]
        ...
        [HttpGet("/api/me/PurchaseOrderVPKM")]
        ...
        [PrivilegeRequirement("OrderVPKM.UpdateNote")]
        [HttpPatch("{id}")]
        ...
        [PrivilegeRequirement("OrderVPKM.Edit")]
