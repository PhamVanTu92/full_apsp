...
class Util
{
    ...
    public static Dictionary<string, string> SortParamsMap(Dictionary<string, string> paramsMap)
    {
        ...
        Dictionary<string, string>
            dictSorted = l.ToDictionary((keyItem) => keyItem.Key, (valueItem) => valueItem.Value);
        return dictSorted;
    }

    public static string ExcuteGetMethod(string url)
    {
    ...
    public static void ExcutePostMethod(string url, Dictionary<string, string> formData,
        Dictionary<string, string> headerRequest)
    {
        ...
        string encodedFormData = string.Join("&",
            formData.Select(kvp => $"{WebUtility.UrlEncode(kvp.Key)}={WebUtility.UrlEncode(kvp.Value)}"));
    ...
    public static string CreateRequestSignatureITA(string method, string uri, List<string> signedHeaderNames,
        Dictionary<string, string> httpHeaders, string merchantId, string merchantHashCode)
    {
        ...
        return
            $"algorithm=\"{signingAlgorithm}\", keyId=\"{merchantId}\", headers=\"{headerNames}\", created={created}, signature=\"{signature}\"";
    }
