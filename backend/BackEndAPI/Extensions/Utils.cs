...
public class VnPayLibrary
{
    ...
    public string CreateRequestUrlTest(string baseUrl , string vnpHashSecret)
    {
        var data = new StringBuilder();
        foreach (var kv in _requestData)
        {
...
// Vấn đề là tạo lần đầu tiên thì thành công nhưng mà nếu như hủy và tạo lại thì thất bại chị ạ. 