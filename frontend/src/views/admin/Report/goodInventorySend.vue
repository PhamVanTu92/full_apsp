    ...
    <div>
      <div class="grid mx-4 my-4">
        <div class="col-6">
          <div class="flex flex-column gap-2">
            <div class="flex gap-8">
              <span class="font-bold w-3">Ngành hàng</span>
              <span class="font-normal">-</span>
            </div>
            <div class="flex gap-8">
              <span class="font-bold w-3">Thương hiệu</span>
              <span class="font-normal">-</span>
            </div>
          </div>
        </div>
        <div class="col-6">
          <div class="flex flex-column gap-2">
            <div class="flex gap-8">
              <span class="font-bold w-3">Quy cách bao bì</span>
              <span class="font-normal">-</span>
            </div>
            <div class="flex gap-8">
              <span class="font-bold w-3">Loại hàng hóa</span>
              <span class="font-normal">-</span>
            </div>
          </div>
        </div>
