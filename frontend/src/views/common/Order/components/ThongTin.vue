    ...
    <div class="grid">
        ...
        <div class="col-12 md:col-4">
            <div class="flex justify-content-between align-items-center mb-2">
                ...
                <Button v-if="!(['DGH','DHT'] as any).includes(odStore.order?.status)" icon="pi pi-pencil" text @click="addressUpdateRef?.open('S')" />
            </div>
            <hr class="mt-0" />
            <div class="field">
        ...
        <div class="col-12 md:col-4">
            <div class="flex justify-content-between align-items-center mb-2">
                ...
                <Button v-if="false" icon="pi pi-pencil" text @click="addressUpdateRef?.open('B')" />
            </div>
            <hr class="mt-0" />
            <div class="field">
                <label>{{ t('client.contact_person') }}</label>
