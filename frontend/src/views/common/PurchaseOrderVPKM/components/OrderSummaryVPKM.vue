<template>
  <div class="border-1 border-green-700 p-3 border-round bg-white">
    ...
    <!-- :disabled="!poStore.model.cardId || !poStore.model.itemDetail.length || poStore.disableOrderButton || (!isConfirmed && props.isClient)" -->
    <Button
      :loading="loading"
      :disabled="!poStore.model.itemDetail.length"
      iconPos="right"
