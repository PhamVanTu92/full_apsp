    ...
    <div class="">
        ...
        <div class="mb-3 mt-5">
            <div class="flex justify-content-between mx-3">
                ...
                <Button @click="onClickUpdate(poStore.model.cardId, 'S')" :label="t('Custom.change')" severity="secondary"/>
            </div>
            <div class="grid m-0">
                <div class="flex col-12 line-field">
                ...
                <div class="flex col-12 line-field">
                    ...
                    <div class="flex-grow-1">
                        {{ poStore.model._customer?.getCrD1Default('S')?.default?.vehiclePlate }}
                    </div>
                </div>
            </div>
        </div>
        <div class="mb-3 mt-5">
            <div class="flex justify-content-between mx-3">
                ...
                <Button @click="onClickUpdate(poStore.model.cardId, 'B')" :label="t('Custom.change')" severity="secondary"/>
            </div>
            <div class="grid m-0">
                <div class="flex col-12 line-field">
        ...
        <CustomerAddress ref="customeAddressRef" @change-default="onChangeDefault"></CustomerAddress>
    </div>
</template>
